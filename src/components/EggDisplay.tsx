                ...
                <div className="flex justify-center px-4">
                    ...
                    <div className="relative w-full max-w-2xl">
                        <div className="relative">
                            <div className="w-full h-[250px] sm:h-[330px] md:h-[380px] lg:h-[450px] flex items-center justify-center bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl border-2 border-[#c8d5db] shadow-2xl p-[5px] sm:p-4 lg:p-6">
