                ...
                <div className="flex justify-center">
                    ...
                    <div className="relative w-full max-w-2xl">
                        <div className="relative">
                            <div className="w-full h-[300px] sm:h-[400px] lg:h-[500px] flex items-center justify-center bg-white rounded-2xl sm:rounded-3xl border-2 border-[#c8d5db] shadow-2xl">
